...
With that being said, this specification establishes a framework to quantify, compare, and evaluate three hedging alternatives of forward contracts, money market hedges, and option-based hedges to determine the most effective strategy for mitigating exchange rate risk and ensuring predictable USD cash flows.
